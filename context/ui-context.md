...
- `cylinder` — Supabase database / storage
...
The project uses `lib/utils.ts` for the shadcn `cn()` helper. Generated `components/ui/*` files are treated as protected foundation components and should not be hand-edited after installation.
