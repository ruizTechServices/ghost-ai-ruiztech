...
Clerk is the authentication provider for this project. Supabase is the main database and persistence platform. Use Supabase Postgres for relational application data and Supabase Storage for generated artifacts such as canvas snapshots and Markdown specs.
